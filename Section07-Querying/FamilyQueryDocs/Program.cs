...
namespace FamilyQueryDocs
{
	class Program
	{
		...
		{
			CreateFamiliesContainerForQueryDemos().Wait();
		}

		public static async Task CreateFamiliesContainerForQueryDemos()
		{
			...
			Console.WriteLine("Successfully created Families container for SQL Query demos");
		}
